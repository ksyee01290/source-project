...
<body>
    ...
    <div class="container">
    	<div class="row">
    	<form method="post" action="updateAction.jsp?sourceID=<%=sourceID%>">
    		<table class="table table-striped" style="tet-align: center; border: 1px solid #dddddd">
    			...
    			<tbody>
    				<tr>
    					<td><input type="text" class="form-control" placeholder="글 제목" name="sourceTitle" maxlength="50" value="<%= source.getSourceTitle()%>"></td>
    				</tr>
    				<tr>
    					<td><textarea class="form-control" placeholder="rmfsodyd" name="sourceContent" maxlength="2048" style="height: 350px;"><%= source.getSourceContent() %></textarea></td>
    				</tr>
    			</tbody>
    		</table>
