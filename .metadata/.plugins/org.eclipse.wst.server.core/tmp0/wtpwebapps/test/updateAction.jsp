...
<body>
    <%
			...
			if(!userID.equals(source.getUserID())){
	    		...
	    		if (request.getParameter("sourceTitle") == null || request.getParameter("sourceContent") == null || request.getParameter("sourceTitle").equals("") || request.getParameter("sourceContent").equals("")){
	    			PrintWriter script = response.getWriter();
	            	script.println("<script>");
		            ...
		            int result = sourceDAO.update(sourceID, request.getParameter("sourceTitle"), request.getParameter("sourceContent"));
		            if (result ==-1){
		                PrintWriter script = response.getWriter();
		                script.println("<script>");
